...
const USER_STATES = {
  ...
  AWAITING_BUSINESS_ADDRESS: "awaiting_business_address",
...
const STATUS_MAP = {
  ...
  [USER_STATES.AWAITING_BUSINESS_ADDRESS]:
    "Collecting business address details",
  ...
  [USER_STATES.AWAITING_PAYMENT]: "Waiting for payment",
  [USER_STATES.PAYMENT_PENDING]: "Payment processing",
